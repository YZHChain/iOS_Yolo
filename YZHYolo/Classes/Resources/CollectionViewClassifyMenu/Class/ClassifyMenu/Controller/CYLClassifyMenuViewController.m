...
- (void)viewDidLoad {
    ...
    self.backgroundView.backgroundColor = [UIColor yzh_backgroundThemeGray];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView
    ...
    (CollectionViewCell *)[collectionView dequeueReusableCellWithReuseIdentifier:kCellIdentifier forIndexPath:indexPath];
    ...
    NSString* text = items[indexPath.row];
    bool shouldShowPic = NO;
    if (shouldShowPic) {
...
- (UICollectionReusableView *)collectionView:(UICollectionView *)collectionView
    ...
    if ([kind isEqual:UICollectionElementKindSectionHeader]) {
        ...
        filterHeaderView.titleLabel.text = sectionTitle;
        filterHeaderView.moreButton.selected = NO;
        filterHeaderView.moreButton.tag = indexPath.section;
//        filterHeaderView.titleLabel.tag = indexPath.section;
//        filterHeaderView.moreButton.tag = indexPath.section;
