...
#define PATH_TEAM_ADDUPDATEGROUP                @"http://192.168.3.47:8082/ymGroup/addGroup"// 增加或修改群资料
#define PATH_TEAM_DELETEGROUP                   @"http://192.168.3.47:8082/ymGroup/delete"// 删除群
#define PATH_TEAM_DELETEMYRECRUITS              @"http://192.168.3.47:8082/ymRecruit/deleteMyRecruits"// 删除我的招募信息
#define PATH_TEAM_PUBLISHMYRECRUITS             @"http://192.168.3.47:8082/ymRecruit/publishMyRecruits"// 发布或编辑招募信息
