...
- (void)layoutSubviews{
    ...
    self.avatarImageView.nim_left = AvatarImageViewLeft;
    ...
    self.textLabel.nim_left = self.avatarImageView.right + MessageAndAvatarSpacing;
    ...
    self.messageLabel.nim_left = self.textLabel.right + TextLabelAndMessageLabelSpacing;
