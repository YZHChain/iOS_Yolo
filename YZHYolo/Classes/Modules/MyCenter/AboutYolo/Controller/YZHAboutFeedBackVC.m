...
@implementation YZHAboutFeedBackVC
...
#endif
            self.url = [NSString stringWithFormat:@"%@%@?yoloid=%@&username=%@&platform=ios" ,urlServerString, PATH_WEB_ABOUTYOLO_FEEDBACK, yolo_no, userNick];
        }
...
-(Boolean)pushCurrentSnapshotViewWithRequest:(NSURLRequest*)request{
    ...
    YZHAboutFeedBackVC* vc = [[YZHAboutFeedBackVC alloc] init];
