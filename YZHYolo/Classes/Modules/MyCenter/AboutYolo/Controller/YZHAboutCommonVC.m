...
@interface YZHAboutCommonVC () <WKUIDelegate,WKScriptMessageHandler,WKNavigationDelegate>
...
@implementation YZHAboutCommonVC
...
-(Boolean)pushCurrentSnapshotViewWithRequest:(NSURLRequest*)request{
    ...
    YZHAboutCommonVC* vc = [[YZHAboutCommonVC alloc] init];
