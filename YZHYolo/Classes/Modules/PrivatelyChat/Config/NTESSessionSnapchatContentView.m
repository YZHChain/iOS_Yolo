...
- (void)layoutSubviews{
    ...
    self.label.nim_left = self.model.message.isOutgoingMsg ? self.imageView.nim_left - customSnapMessageImageRightToText - self.label.width : self.imageView.right + customSnapMessageImageRightToText;
